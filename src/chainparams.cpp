...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x79b3762bd1ae9b9bda41c8217a7f535c8313c0802ec1763c76cf967ff698a18c");
        ...
        genesis = CreateGenesisBlock(1634531132, 43605426, 0x1d5fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        // PoW: 000000155cfc932f6d070364b2a88805992dfaaff835b2648fde1613e6fe2ef2
        assert(consensus.hashGenesisBlock == uint256S("0x79b3762bd1ae9b9bda41c8217a7f535c8313c0802ec1763c76cf967ff698a18c"));
        ...
        checkpointData = {
            {
                { 0, uint256S("0x79b3762bd1ae9b9bda41c8217a7f535c8313c0802ec1763c76cf967ff698a18c")},
            }
        };
