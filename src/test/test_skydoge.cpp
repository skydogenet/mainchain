...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = fs::temp_directory_path() / strprintf("test_skydoge_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
...
// old DC sidechain activation
bool ActivateSidechainOLD(SidechainDB& scdbTest, Sidechain proposal, int nHeight, bool fGenerateKey)
{
