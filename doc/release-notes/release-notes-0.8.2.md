...
The default fee for low-priority transactions is lowered from 0.0005 SKYDOGE 
(for each 1,000 bytes in the transaction; an average transaction is
about 500 bytes) to 0.0001 SKYDOGE.

Payments (transaction outputs) of 0.543 times the minimum relay fee
(0.00005430 SKYDOGE) are now considered 'non-standard', because storing them
