...
Use the correct base transaction fee of 0.0005 SKYDOGE for accepting transactions into mined blocks (since 0.4.0, it was incorrectly accepting 0.0001 SKYDOGE which was only meant to be relayed).
