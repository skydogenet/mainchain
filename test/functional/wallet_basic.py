...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 SKYDOGE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 SKYDOGE with subtract fee from amount
        ...
        # Sendmany 10 SKYDOGE with subtract fee from amount
