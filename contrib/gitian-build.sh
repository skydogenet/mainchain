...
SIGNER=skydoge
VERSION="11149a60553416fca8a382ece1f3d3c25cd68a07"
commit=false
...
if [[ $commit = false ]]
then
	COMMIT="11149a60553416fca8a382ece1f3d3c25cd68a07"
fi
echo ${COMMIT}
...
then
	...
	then
	    ...
	    ./bin/gbuild -j ${proc} -m ${mem}  --commit mainchain="11149a60553416fca8a382ece1f3d3c25cd68a07" --url mainchain="https://github.com/skydogenet/mainchain"  ../../contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mainchain="11149a60553416fca8a382ece1f3d3c25cd68a07" --url mainchain="https://github.com/skydogenet/mainchain" ../../contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mainchain="11149a60553416fca8a382ece1f3d3c25cd68a07" --url mainchain="https://github.com/skydogenet/mainchain" ../../contrib/gitian-descriptors/gitian-osx.yml
