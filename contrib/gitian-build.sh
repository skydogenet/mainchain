...
SIGNER=skydoge
VERSION="ecc5cb99b07bfc97266facbc1f6c723bee798461"
commit=false
...
if [[ $commit = false ]]
then
	COMMIT="ecc5cb99b07bfc97266facbc1f6c723bee798461"
fi
echo ${COMMIT}
...
then
	...
	then
	    ...
	    ./bin/gbuild -j ${proc} -m ${mem}  --commit mainchain="ecc5cb99b07bfc97266facbc1f6c723bee798461" --url mainchain="https://github.com/skydogenet/mainchain"  ../../contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mainchain="ecc5cb99b07bfc97266facbc1f6c723bee798461" --url mainchain="https://github.com/skydogenet/mainchain" ../../contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    echo ""
	    ./bin/gbuild -j ${proc} -m ${mem} --commit mainchain="ecc5cb99b07bfc97266facbc1f6c723bee798461" --url mainchain="https://github.com/skydogenet/mainchain" ../../contrib/gitian-descriptors/gitian-osx.yml
